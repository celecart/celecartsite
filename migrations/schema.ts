...
export const blogs = pgTable("blogs", {
	...
	check("blogs_id_not_null", sql`NOT NULL id`),
	check("blogs_title_not_null", sql`NOT NULL title`),
	check("blogs_content_not_null", sql`NOT NULL content`),
	check("blogs_author_id_not_null", sql`NOT NULL author_id`),
	check("blogs_category_not_null", sql`NOT NULL category`),
	check("blogs_is_published_not_null", sql`NOT NULL is_published`),
	check("blogs_created_at_not_null", sql`NOT NULL created_at`),
	check("blogs_updated_at_not_null", sql`NOT NULL updated_at`),
	check("blogs_view_count_not_null", sql`NOT NULL view_count`),
	check("blogs_likes_not_null", sql`NOT NULL likes`),
]);
