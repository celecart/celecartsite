...
import { User, Edit, Save, X, Star, Camera, Upload } from "lucide-react";
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <Tabs defaultValue="basic" className="w-full">
              <TabsList className={`grid w-full ${canAccessCelebrityDetails() ? 'grid-cols-3' : 'grid-cols-1'} bg-white/5 border-white/10`}>
